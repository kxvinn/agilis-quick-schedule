  ...
  return (
    <section className="pt-28 pb-16 md:pt-36 md:pb-24 hero-gradient overflow-hidden dark:bg-zinc-950">
      <div className="container mx-auto px-4">
        ...
        >
          <h1 className="text-4xl md:text-6xl font-bold text-agilis-dark mb-6 dark:text-white">
          Agende com facilidade. <span className="text-agilis-accent">Cresça com eficiência.</span> 
          </h1>
          <p className="text-xl md:text-2xl text-gray-700 mb-8 max-w-2xl mx-auto dark:text-gray-200">
          ...
          <div className="flex flex-col sm:flex-row items-center justify-center gap-4">
            <Link to="/signup">
              <Button size="lg" className="bg-agilis-accent text-white hover:bg-agilis-accent/90 text-lg px-8 btn-hover dark:text-black">
                Comece de graça
